export default function CourseList() {
  return (
    <div className="flex mt-10 flex-col justify-center items-center md:p-10">
      <div className="w-screen md:pl-20 mb-24 px-5">
      ...
      <div className="flex flex-col xl:flex-row justify-around items-center w-screen md:px-20">
